...
public class GetData {
    ...
    public void setContainData(Integer userID){
        params = new ArrayList<>();
        ...
        try {
            containArr = new JSONArray(HttpManager.getInstance().getHttpPost(Constant.URL+Constant.URL_GET_CONTAIN_BY_USERID,params));
